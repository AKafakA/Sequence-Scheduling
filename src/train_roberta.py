...
def parse_args():
    ...
    parser.add_argument("--train-data-path", type=str, default="data/sharegpt_qwen_train_40k.json")
    parser.add_argument("--val-data-path", type=str, default="data/sharegpt_qwen_val_10k.json")
    parser.add_argument("--output-dir", type=str, default="./ckpts/roberta-length-prediction/sharegpt-qwen-base_b8_e400")
